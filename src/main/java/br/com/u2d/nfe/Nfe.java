...
import br.com.u2d.nfe.dom.enuns.ConsultaDFeEnum;
...
import br.com.u2d.nfe.schema.retdistdfeint.RetDistDFeInt;
import br.com.u2d.nfe.schema_4.enviNFe.TEnviNFe;
import br.com.u2d.nfe.schema_4.enviNFe.TRetEnviNFe;
import br.com.u2d.nfe.schema_4.inutNFe.TInutNFe;
import br.com.u2d.nfe.schema_4.inutNFe.TRetInutNFe;
import br.com.u2d.nfe.schema_4.retConsReciNFe.TRetConsReciNFe;
...
import br.com.u2d.nfe.util.ConfiguracoesUtil;
...
public class Nfe {
     ...
     * @throws NfeException
     */
    public static br.com.u2d.nfe.schema.envEventoCancSubst.TRetEnvEvento cancelarSubstituicaoNfe(ConfiguracoesNfe configuracoesNfe, br.com.u2d.nfe.schema.envEventoCancSubst.TEnvEvento envEvento, boolean valida) throws NfeException {
     ...
     * @throws NfeException
     */
    public static br.com.u2d.nfe.schema.envEpec.TRetEnvEvento enviarEpec(ConfiguracoesNfe configuracoesNfe, br.com.u2d.nfe.schema.envEpec.TEnvEvento envEvento, boolean valida) throws NfeException {
     ...
     * @throws NfeException
     */
    public static br.com.u2d.nfe.schema.envcce.TRetEnvEvento cce(ConfiguracoesNfe configuracoesNfe,
                                                                           br.com.u2d.nfe.schema.envcce.TEnvEvento evento, boolean valida) throws NfeException {
     ...
     * @throws NfeException
     */
    public static br.com.u2d.nfe.schema.envConfRecebto.TRetEnvEvento manifestacao(ConfiguracoesNfe configuracoesNfe,
                                                                                            br.com.u2d.nfe.schema.envConfRecebto.TEnvEvento evento, boolean valida) throws NfeException {
