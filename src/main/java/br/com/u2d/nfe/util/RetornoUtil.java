...
public class RetornoUtil {
     ...
     * @throws NfeException
     */
    public static void validaCancelamentoSubstituicao(br.com.u2d.nfe.schema.envEventoCancSubst.TRetEnvEvento retorno) throws NfeException {
        if (!StatusEnum.LOTE_EVENTO_PROCESSADO.getCodigo().equals(retorno.getCStat())) {
            throw new NfeException(retorno.getCStat() + " - " + retorno.getXMotivo());
        }
     ...
     * @throws NfeException
     */
    public static void validaManifestacao(br.com.u2d.nfe.schema.envConfRecebto.TRetEnvEvento retorno) throws NfeException {
        if (!StatusEnum.LOTE_EVENTO_PROCESSADO.getCodigo().equals(retorno.getCStat())) {
            throw new NfeException(retorno.getCStat() + " - " + retorno.getXMotivo());
        }
     ...
     * @throws NfeException
     */
    public static void validaCartaCorrecao(br.com.u2d.nfe.schema.envcce.TRetEnvEvento retorno) throws NfeException {
        if (!StatusEnum.LOTE_EVENTO_PROCESSADO.getCodigo().equals(retorno.getCStat())) {
            throw new NfeException(retorno.getCStat() + " - " + retorno.getXMotivo());
        }
        final String[] erro = {""};
     ...
     * @throws NfeException
     */
    public static void validaEpec(br.com.u2d.nfe.schema.envEpec.TRetEnvEvento retorno) throws NfeException {
        if (!StatusEnum.LOTE_EVENTO_PROCESSADO.getCodigo().equals(retorno.getCStat())) {
            throw new NfeException(retorno.getCStat() + " - " + retorno.getXMotivo());
     ...
     * @throws NfeException
     */
    public static void validaConsultaCadastro(br.com.u2d.nfe.schema.retConsCad.TRetConsCad retorno) throws NfeException {
     ...
     * @throws NfeException
     */
    public static void validaInutilizacao(br.com.u2d.nfe.schema_4.inutNFe.TRetInutNFe retorno) throws NfeException {
