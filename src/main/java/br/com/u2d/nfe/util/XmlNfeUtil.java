...
import br.com.u2d.nfe.schema.distdfeint.DistDFeInt;
import br.com.u2d.nfe.schema.envEventoCancNFe.TEnvEvento;
import br.com.u2d.nfe.schema.envEventoCancNFe.TRetEnvEvento;
import br.com.u2d.nfe.schema_4.consReciNFe.TConsReciNFe;
import br.com.u2d.nfe.schema_4.consSitNFe.TConsSitNFe;
import br.com.u2d.nfe.schema_4.consStatServ.TConsStatServ;
import br.com.u2d.nfe.schema_4.enviNFe.*;
    ...
    public static <T> String objectToXml(Object obj) throws JAXBException, NfeException {
        ...
        switch (obj.getClass().getSimpleName()) {
            ...
            case STATUS:
                ...
                element = new br.com.u2d.nfe.schema_4.consStatServ.ObjectFactory().createConsStatServ((TConsStatServ) obj);
                break;

            case ENVIO_NFE:
                context = JAXBContext.newInstance(TEnviNFe.class);
                element = new br.com.u2d.nfe.schema_4.enviNFe.ObjectFactory().createEnviNFe((TEnviNFe) obj);
                break;
            ...
            case SITUACAO_NFE:
                ...
                element = new br.com.u2d.nfe.schema_4.consSitNFe.ObjectFactory().createConsSitNFe((TConsSitNFe) obj);
                break;

            case DIST_DFE:
                context = JAXBContext.newInstance(DistDFeInt.class);
                element = new br.com.u2d.nfe.schema.distdfeint.ObjectFactory().createDistDFeInt((DistDFeInt) obj);
                break;

            case TCONSRECINFE:
                context = JAXBContext.newInstance(TConsReciNFe.class);
                element = new br.com.u2d.nfe.schema_4.consReciNFe.ObjectFactory().createConsReciNFe((TConsReciNFe) obj);
                break;

            case TCONS_CAD:
                context = JAXBContext.newInstance(TConsCad.class);
                element = new br.com.u2d.nfe.schema.consCad.ObjectFactory().createConsCad((TConsCad) obj);
                break;

            case INUTILIZACAO:
                context = JAXBContext.newInstance(TInutNFe.class);
                element = new br.com.u2d.nfe.schema_4.inutNFe.ObjectFactory().createInutNFe((TInutNFe) obj);
                break;
            ...
            case SITUACAO_NFE_RET:
                ...
                element = new br.com.u2d.nfe.schema_4.retConsSitNFe.ObjectFactory().createRetConsSitNFe((TRetConsSitNFe) obj);
                break;

            case RET_RECIBO_NFE:
                context = JAXBContext.newInstance(br.com.u2d.nfe.schema_4.retConsReciNFe.TRetConsReciNFe.class);
                element = new br.com.u2d.nfe.schema_4.retConsReciNFe.ObjectFactory().createRetConsReciNFe((br.com.u2d.nfe.schema_4.retConsReciNFe.TRetConsReciNFe) obj);
                break;

            case RET_STATUS_SERVICO:
                context = JAXBContext.newInstance(br.com.u2d.nfe.schema_4.retConsStatServ.TRetConsStatServ.class);
                element = new br.com.u2d.nfe.schema_4.retConsStatServ.ObjectFactory().createRetConsStatServ((br.com.u2d.nfe.schema_4.retConsStatServ.TRetConsStatServ) obj);
                break;

            case TPROCEVENTO:
                switch (obj.getClass().getName()) {
                    case TPROCCANCELAR:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envEventoCancNFe.TProcEvento.class);
                        element = new br.com.u2d.nfe.schema.envEventoCancNFe.ObjectFactory().createTProcEvento((br.com.u2d.nfe.schema.envEventoCancNFe.TProcEvento) obj);
                        break;
                    case TPROCCANCELARSUBST:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envEventoCancSubst.TProcEvento.class);
                        element = new br.com.u2d.nfe.schema.envEventoCancSubst.ObjectFactory().createTProcEvento((br.com.u2d.nfe.schema.envEventoCancSubst.TProcEvento) obj);
                        break;
                    case TPROCCCE:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envcce.TProcEvento.class);
                        element = new br.com.u2d.nfe.schema.envcce.ObjectFactory().createTProcEvento((br.com.u2d.nfe.schema.envcce.TProcEvento) obj);
                        break;
                    case TPROCEPEC:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envEpec.TProcEvento.class);
                        element = XsdUtil.epec.createTProcEvento((br.com.u2d.nfe.schema.envEpec.TProcEvento) obj);
                        break;
                }
            ...
            case NFE:
                ...
                element = new JAXBElement<>(new QName("http://www.portalfiscal.inf.br/nfe", "NFe"), TNFe.class, null, (br.com.u2d.nfe.schema_4.enviNFe.TNFe) obj);
                break;
            ...
            case EVENTO:
                switch (obj.getClass().getName()) {
                    case CANCELAR:
                        ...
                        element = new br.com.u2d.nfe.schema.envEventoCancNFe.ObjectFactory().createEnvEvento((TEnvEvento) obj);
                        break;
                    case CANCELAR_SUBSTITUICAO:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envEventoCancSubst.TEnvEvento.class);
                        element = new br.com.u2d.nfe.schema.envEventoCancSubst.ObjectFactory().createEnvEvento((br.com.u2d.nfe.schema.envEventoCancSubst.TEnvEvento) obj);
                        break;
                    case CCE:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envcce.TEnvEvento.class);
                        element = new br.com.u2d.nfe.schema.envcce.ObjectFactory().createEnvEvento((br.com.u2d.nfe.schema.envcce.TEnvEvento) obj);
                        break;
                    case EPEC:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envEpec.TEnvEvento.class);
                        element = new br.com.u2d.nfe.schema.envEpec.ObjectFactory().createEnvEvento((br.com.u2d.nfe.schema.envEpec.TEnvEvento) obj);
                        break;
                    case MANIFESTAR:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envConfRecebto.TEnvEvento.class);
                        element = new br.com.u2d.nfe.schema.envConfRecebto.ObjectFactory().createEnvEvento((br.com.u2d.nfe.schema.envConfRecebto.TEnvEvento) obj);
                        break;
                }
                break;
            ...
            case RET_ENV_EVENTO:
                switch (obj.getClass().getName()) {
                    ...
                    case RET_CANCELAR_SUBSTITUICAO:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envEventoCancSubst.TRetEnvEvento.class);
                        element = XsdUtil.retEnvEvento.createTRetEnvEvento((br.com.u2d.nfe.schema.envEventoCancSubst.TRetEnvEvento) obj);
                        break;
                    case RET_CCE:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envcce.TRetEnvEvento.class);
                        element = XsdUtil.retEnvEvento.createTRetEnvEvento((br.com.u2d.nfe.schema.envcce.TRetEnvEvento) obj);
                        break;
                    case RET_EPEC:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envEpec.TRetEnvEvento.class);
                        element = XsdUtil.retEnvEvento.createTRetEnvEvento((br.com.u2d.nfe.schema.envEpec.TRetEnvEvento) obj);
                        break;
                    case RET_MANIFESTAR:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema.envConfRecebto.TRetEnvEvento.class);
                        element = XsdUtil.retEnvEvento.createTRetEnvEvento((br.com.u2d.nfe.schema.envConfRecebto.TRetEnvEvento) obj);
                        break;
                }
                break;
            ...
            case TProtNFe:
                switch (obj.getClass().getName()) {
                    case TProtEnvi:
                        ...
                        element = XsdUtil.enviNfe.createTProtNFe((br.com.u2d.nfe.schema_4.enviNFe.TProtNFe) obj);
                        break;
                    case TProtCons:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema_4.retConsSitNFe.TProtNFe.class);
                        element = XsdUtil.retConsSitNfe.createTProtNFe((br.com.u2d.nfe.schema_4.retConsSitNFe.TProtNFe) obj);
                        break;
                    case TProtReci:
                        context = JAXBContext.newInstance(br.com.u2d.nfe.schema_4.retConsReciNFe.TProtNFe.class);
                        element = XsdUtil.retConsReciNfe.createTProtNFe((br.com.u2d.nfe.schema_4.retConsReciNFe.TProtNFe) obj);
                        break;
                }
                break;
